...
public:
	...
	void show_stats()
	{
		...
		// calulate avg wait departure  and display 
		int average_wait_departure = total_wait_departure / total_served_landing;
		std::cout << "departure average wait time: " << average_wait_departure << " minutes. " << std::endl;
		std::cout << std::endl;
